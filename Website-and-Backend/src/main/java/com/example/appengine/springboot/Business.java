...
public class Business {
    ...
    public Business(@JsonProperty("name") String name, // Business Profile:
                    ...
                    @JsonProperty("bcorpCommunityScore") double bcorpCommunityScore, // Numerical Data for Calculation:
                    ...
                    @JsonProperty("betterBusinessBureau") String betterBusinessBureau, // Boolean Data for Calculation:
    ...
    public void calculate() {
        if (this.overallScore == 0) {
            ...
            for (int a = 0; a < scoreGuideAnimal.length; ++a) {
                if (ethicalElephantCrueltyFreeVeganSwitch && this.ethicalElephantCrueltyFree && this.ethicalElephantType.equals("Vegan")) {
                    cumulativeAnimalScore += scoreGuideAnimal[a] - (rangeAnimal / 2) + (rangeAnimal * (ethicalElephantCrueltyFreeVeganWeight / animalWeightMean) / 2);
                    ethicalElephantCrueltyFreeVeganSwitch = false;
                    ++animalFactors;
                } else if (veganDotOrgCertifiedSwitch && this.veganDotOrgCertified) {
                    cumulativeAnimalScore += scoreGuideAnimal[a] - (rangeAnimal / 2) + (rangeAnimal * (veganDotOrgCertifiedWeight / animalWeightMean) / 2);
                    veganDotOrgCertifiedSwitch = false;
                    ++animalFactors;
                } else if (chooseCrueltyFreeVeganSwitch && this.chooseCrueltyFreeCertified && this.chooseCrueltyFreeVegan) {
                    cumulativeAnimalScore += scoreGuideAnimal[a] - (rangeAnimal / 2) + (rangeAnimal * (chooseCrueltyFreeVeganWeight / animalWeightMean) / 2);
                    chooseCrueltyFreeVeganSwitch = false;
                    ++animalFactors;
                } else if (ethicalElephantCrueltyFreeVeganOptionsSwitch && this.ethicalElephantCrueltyFree && this.ethicalElephantType.equals("Vegan Options")) {
                    cumulativeAnimalScore += scoreGuideAnimal[a] - (rangeAnimal / 2) + (rangeAnimal * (ethicalElephantCrueltyFreeVeganOptionsWeight / animalWeightMean) / 2);
                    ethicalElephantCrueltyFreeVeganOptionsSwitch = false;
                    ++animalFactors;
                } else if (ethicalElephantCrueltyFreeSwitch && this.ethicalElephantCrueltyFree && this.ethicalElephantType.equals("")) {
                    cumulativeAnimalScore += scoreGuideAnimal[a] - (rangeAnimal / 2) + (rangeAnimal * (ethicalElephantCrueltyFreeWeight / animalWeightMean) / 2);
                    ethicalElephantCrueltyFreeSwitch = false;
                    ++animalFactors;
                } else if (leapingBunnySwitch && this.leapingBunnyCertified) {
                    cumulativeAnimalScore += scoreGuideAnimal[a] - (rangeAnimal / 2) + (rangeAnimal * (leapingBunnyWeight / animalWeightMean) / 2);
                    leapingBunnySwitch = false;
                    ++animalFactors;
                } else if (certifiedHumaneSwitch && this.certifiedHumane) {
                    cumulativeAnimalScore += scoreGuideAnimal[a] - (rangeAnimal / 2) + (rangeAnimal * (certifiedHumaneWeight / animalWeightMean) / 2);
                    certifiedHumaneSwitch = false;
                    ++animalFactors;
                } else if (chooseCrueltyFreeSwitch && this.chooseCrueltyFreeCertified && !this.chooseCrueltyFreeVegan) {
                    cumulativeAnimalScore += scoreGuideAnimal[a] - (rangeAnimal / 2) + (rangeAnimal * (chooseCrueltyFreeWeight / animalWeightMean) / 2);
