...
/* Documentation: http://www.schillmania.com/projects/snowstorm/ */
...
const snowStorm = (function(window, document) {
  ...
  let screenX = null; let screenX2 = null; let screenY = null; let scrollY = null; let docHeight = null; let vRndX = null; let vRndY = null;
  let windOffset = 1;
  ...
  this.events = (function() {
	  const old = (!window.addEventListener && window.attachEvent); const slice = Array.prototype.slice;
	  const evt = {
      ...
      const args = slice.call(oArgs); const len = args.length;
      if (old) {
  ...
  this.SnowFlake = function(type, x, y) {
	  ...
	  this.move = function() {
      const vX = s.vX * windOffset; let yDiff;
      s.x += vX;
      s.y += (s.vY * s.vAmp);
  ...
  this.snow = function() {
	  let active = 0; let flake = null; let i; let j;
